...
<html>
    ...
    <body>
        ...
        <form action="login2Frame" name="myForm" onsubmit="return namevalidate()" method="post">
        <!--Header Menu List -->
        <ul>
        ...
        <center>
                ...
                <input class="btn" type="submit" name="submit" value="Continue"  /> <a href="login.php"><button class="btn">Logout</button></a>
                <br><br><br>
