...
<html>
    ...
    <body>
        ...
        if($from_balance >= $entered_amount && $bool === TRUE){
            $from_updated_balance = $from_balance - $entered_amount - 0.03*$entered_amount;
        ...
        if (mysqli_query($con,$sql))
            ...
            /*$sql1 = "INSERT INTO goldtrans (tid,tfrom,tto,tdate,ttime,tamount,transmode,goldamt) VALUES ($randnum,'$from_accnum','$entered_accnum','$tdate','$ttime',$entered_amount,'$accounttrans','$goldamts')";
