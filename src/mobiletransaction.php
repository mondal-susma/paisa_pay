...
<html>
    ...
    <body>
        ...
        <center>
            ...
            <form action="mobiletransaction1.php" name="myForm" method="post">
                <label for="fname">Phone number of Reciever*</label>   <input id= "greybg" type="number" id="entered_mobilenum" name="entered_mobilenum" minlength="10" maxlength="10" pattern="[0-9]{10}" placeholder="Enter Phone number" value="" required><br>
